...
public class Customer  {
	...
	public void dineAndPayCheck(FoodPlace foodPlace, double menuPrice ) {
		...
		double customerTipPct = this.getTargetTipPct();
		double foodPlaceTipPct = foodPlace.getTipPercentage();
		double avgTipPct = (customerTipPct + foodPlaceTipPct) / 2;
		check.setTipByPct(avgTipPct);
